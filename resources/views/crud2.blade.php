@extends('layouts.app',['pageTitle' => __('Crud 2')])
@section('content')
                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('jsonSave') }}" method="post">
                        ...
                        <div class="form-inline m-1" style="padding: 10px">
                            ...
                            <a href="#" style="margin-left: 5px" class="btn btn-success btn-sm add-row "><i class="fa fa-plus"
                                    aria-hidden="true"></i></a>
                            {{-- <input type="checkbox" name="" id="foreginKeyDivShow" > --}}
                            <div style="margin-left: 5px">
                                <input type="checkbox" id="foreginKeyDivShow">
                                <label for="foreginKeyDivShow"></label>
                            </div>
