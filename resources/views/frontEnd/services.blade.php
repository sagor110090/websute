    ...
    <div class="auto-container">
        ...
        <div class="row clearfix">
            ...
            <div class="service-block-three style-two col-lg-4 col-md-6 col-sm-12">
                <div class="inner-box">
                    <div class="image">
                        <a href="{{url('/service-details', [$item->slug])}}"><img class="project_thambnill"
                                src="{{asset(Storage::url($item->image))}}" alt="" /></a>
                    </div>
                    <div class="lower-content">
                        <h4><a href="{{url('/service-details', [$item->slug])}}">{{$item->header}}</a></h4>
                        <div class="text">{!! Helpers::limit_text($item->shortDescription, 20) !!}</div>
                        <a href="{{url('/service-details', [$item->slug])}}" class="plus-box"><span
